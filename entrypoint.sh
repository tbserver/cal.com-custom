...
export NEXT_PUBLIC_API_V2_URL="${CALCOM_NEXT_PUBLIC_API_V2_URL:-${NEXT_PUBLIC_WEBAPP_URL%/}/api/v2}"
export CALENDSO_ENCRYPTION_KEY="${CALCOM_CALENDSO_ENCRYPTION_KEY}"
export CALCOM_LICENSE_KEY="${CALCOM_LICENSE_KEY:-${CALCOM_CALCOM_LICENSE_KEY:-}}"
